      ...
      <div className="max-w-[1240px] mx-auto px-4 py-16">
        <div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            text='Integrate pre-built, time-tested oracle solutions that already secure tens
             of billions in smart contract value for 
             market-leading decentralized applications.'  />
            ...
            text='Use a decentralized network of DeFi Keeper nodes to automate contracts,
             mitigating risk of manual interventions
